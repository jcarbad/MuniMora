                            ...
                            <form method="POST" action="modificarNotificacion_exec.php?id1=<?php echo $row[0];?>" accept-charset='UTF-8' onSubmit="return validarNotificacionEditar()"
                              ...
                              <td>Expediente:
                                <div class="form-group" id="groupExp">
                                  <input class="form-control" id="exp" name="exp" autofocus="true" type="number" value="<?php echo $row[0];?>"></input>
                                </div>
                              </td>
                              <td>Propietario:
                              ...
                              <td>Fecha Caducacion:
                                <div class="form-group" id="groupCaducacion">
                                  <input class="form-control" id="caducacion" name="caducacion" autofocus="true" type="date" value="<?php echo $row[3];?>"></input>
                                </div>
                              </td>
                              <td>Descripcion:
